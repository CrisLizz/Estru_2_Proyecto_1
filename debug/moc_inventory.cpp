...
#include "../../../../../../OneDrive - Universidad Tecnologica Centroamericana/Documents/QT Proyects/Proyecto1_Estru2/inventory.h"
...
namespace {
struct qt_meta_tag_ZN9InventoryE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9InventoryE = QtMocHelpers::stringData(
    "Inventory"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9InventoryE[] = {
...
Q_CONSTINIT const QMetaObject Inventory::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9InventoryE.offsetsAndSizes,
    qt_meta_data_ZN9InventoryE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9InventoryE_t,
        // Q_OBJECT / Q_GADGET
...
void *Inventory::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9InventoryE.stringdata0))
